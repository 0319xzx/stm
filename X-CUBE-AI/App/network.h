...
#define AI_NETWORK_ORIGIN_MODEL_NAME   "binary_model_int8"
...
#define AI_NETWORK_IN_1_HEIGHT      (98)
#define AI_NETWORK_IN_1_WIDTH       (40)
#define AI_NETWORK_IN_1_CHANNEL     (1)
#define AI_NETWORK_IN_1_SIZE        (3920)
#define AI_NETWORK_IN_1_SIZE_BYTES  (3920)
